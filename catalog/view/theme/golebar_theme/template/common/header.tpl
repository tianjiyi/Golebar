      ...
      <div class="col-md-7">
		  ...
		  <div class="col-md-11" style="padding:0; margin:0;">
			  <!-- <span id="search-top">海量香辣卤味零食！购满$45你的邮费我们包了!</span> -->
                          <a href="http://golebar.com/index.php?route=product/search&search=<?php echo $text_search_shortcut1; ?>" style="color:rgb(52,152,219);"><span style="padding-left:10px;"><?php echo $text_search_shortcut1; ?></span></a><a href="http://golebar.com/index.php?route=product/product&product_id=632&search=<?php echo $text_search_shortcut2; ?>" style="color:rgb(52,152,219);"><span style="padding-left:7px;"><?php echo $text_search_shortcut2; ?></span></a><a href="http://golebar.com/index.php?route=product/search&search=<?php echo $text_search_shortcut3; ?>" style="color:rgb(52,152,219);"><span style="padding-left:7px;"><?php echo $text_search_shortcut3; ?></span></a><a href="http://golebar.com/index.php?route=product/search&search=<?php echo $text_search_shortcut4; ?>" style="color:rgb(52,152,219);"><span style="padding-left:7px;"><?php echo $text_search_shortcut4; ?></span></a><a href="http://golebar.com/index.php?route=product/search&search=<?php echo $text_search_shortcut5; ?>" style="color:rgb(52,152,219);"><span style="padding-left:7px;"><?php echo $text_search_shortcut5; ?></span></a><a href="http://golebar.com/index.php?route=product/category&path=<?php echo $text_search_shortcut6; ?>" style="color:rgb(52,152,219);"><span style="padding-left:7px;"><?php echo $text_search_shortcut6; ?></span></a>
			  <?php echo $search; ?>
