    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="row">
        ...
        <div class="col-sm-1 col-sm-offset-2 text-right">
          <label class="control-label" for="input-sort" style="line-height:34px;"><?php echo $text_sort; ?></label>
        </div>
        ...
        <div class="col-sm-1 text-right">
          <label class="control-label" for="input-limit" style="line-height:34px;"><?php echo $text_limit; ?></label>
        </div>
        ...
        <div class="product-layout product-list col-xs-12">
          <div class="product-thumb" style="max-height:330px; background-color:white; border:0;  overflow-y: hidden;">
            ...
            <div class="caption" style="line-height:14px; margin-top:25px;">
              ...
              <p class="price" style="color:#ff2a69; font-size:12px; padding-top:12px;">
