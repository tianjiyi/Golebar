...
class ControllerModuleCategoryPictures extends Controller {
    ...
    public function index() {
        ...
        $data['entry_image1_title_en'] = $this->language->get('entry_image1_title_en');
        $data['entry_image2_title_en'] = $this->language->get('entry_image2_title_en');
        $data['entry_image3_title_en'] = $this->language->get('entry_image3_title_en');
        $data['entry_image4_title_en'] = $this->language->get('entry_image4_title_en');
        ...
        //english version
        if (isset($this->request->post['categorypictures_image1title_en'])) {
            $data['categorypictures_image1title_en'] = $this->request->post['categorypictures_image1title_en'];
        } else {
            $data['categorypictures_image1title_en'] = $this->config->get('categorypictures_image1title_en');
        }

        if (isset($this->request->post['categorypictures_image2title_en'])) {
            $data['categorypictures_image2title_en'] = $this->request->post['categorypictures_image2title_en'];
        } else {
            $data['categorypictures_image2title_en'] = $this->config->get('categorypictures_image2title_en');
        }

        if (isset($this->request->post['categorypictures_image3title_en'])) {
            $data['categorypictures_image3title_en'] = $this->request->post['categorypictures_image3title_en'];
        } else {
            $data['categorypictures_image3title_en'] = $this->config->get('categorypictures_image3title_en');
        }

        if (isset($this->request->post['categorypictures_image4title_en'])) {
            $data['categorypictures_image4title_en'] = $this->request->post['categorypictures_image4title_en'];
        } else {
            $data['categorypictures_image4title_en'] = $this->config->get('categorypictures_image4title_en');
        }
