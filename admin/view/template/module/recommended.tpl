    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-featured" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-imagelink"><?php echo $entry_imagelink; ?></label>
            <div class="col-sm-10">
              <input type="text" name="imagelink" value="<?php echo $imagelink; ?>" placeholder="<?php echo $entry_imagelink; ?>" id="input-imagelink" class="form-control" />
            </div>
          </div>
          ...
          <div class="form-group">
			...
			<div class="col-sm-9">
            	...
            	<input type="hidden" name="recommended_image1" value="<?php echo $recommended_image1; ?>" id="input-logo1" />
            </div>
         </div>
