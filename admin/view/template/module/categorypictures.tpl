        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-categorypictures" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-categorypictures_image1title_en"><?php echo $entry_image1_title_en; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="categorypictures_image1title_en" value="<?php echo $categorypictures_image1title_en; ?>" placeholder="<?php echo $entry_image1_title_en; ?>" id="input-categorypictures_image1title_en" class="form-control" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-categorypictures_image2title_en"><?php echo $entry_image2_title_en; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="categorypictures_image2title_en" value="<?php echo $categorypictures_image2title_en; ?>" placeholder="<?php echo $entry_image2_title_en; ?>" id="input-categorypictures_image2title_en" class="form-control" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-categorypictures_image3title_en"><?php echo $entry_image3_title_en; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="categorypictures_image3title_en" value="<?php echo $categorypictures_image3title_en; ?>" placeholder="<?php echo $entry_image3_title_en; ?>" id="input-categorypictures_image3title_en" class="form-control" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-categorypictures_image4title_en"><?php echo $entry_image4_title_en; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="categorypictures_image4title_en" value="<?php echo $categorypictures_image4title_en; ?>" placeholder="<?php echo $entry_image4_title_en; ?>" id="input-categorypictures_image4title_en" class="form-control" />
                        </div>
                    </div>
