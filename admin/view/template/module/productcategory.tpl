    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-featured" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-selected"><?php echo $entry_selected; ?></label>
            <div class="col-sm-10">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="selectedlink" value="<?php echo $selectedlink; ?>" placeholder="<?php echo $entry_selectedlink; ?>" id="input-selectedlink" class="form-control" />
            </div>
          </div>
      	 ...
      	 <div class="form-group">
			...
			<div class="col-sm-9">
            	...
            	<input type="hidden" name="productcategory_image1" value="<?php echo $productcategory_image1; ?>" id="input-logo1" />
            </div>
         </div>
         ...
         <div class="form-group">
			...
			<div class="col-sm-9">
            	...
            	<input type="hidden" name="productcategory_image2" value="<?php echo $productcategory_image2; ?>" id="input-logo2" />
            </div>
         </div>
         
      <div class="form-group">
        <label class="col-sm-2 control-label" for="input-image2link"><?php echo $entry_image2_link; ?></label>
        <div class="col-sm-10">
          <input type="text" name="image2link" value="<?php echo $image2link; ?>" placeholder="<?php echo $entry_image2_link; ?>" id="input-image2link" class="form-control" />
        </div>
      </div>
      ...
      <div class="form-group">
        <label class="col-sm-2 control-label" for="input-adtitle"><?php echo $entry_ad_title; ?></label>
        <div class="col-sm-10">
          <input type="text" name="adtitle" value="<?php echo $adtitle; ?>" placeholder="<?php echo $entry_ad_title; ?>" id="input-adtitle" class="form-control" />
        </div>
      </div>
